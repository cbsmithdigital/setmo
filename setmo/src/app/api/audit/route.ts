...
export async function POST(req: Request) {
  ...
  const { contactName, practiceName, workEmail, caseValueUsd, monthlyLeads } = parsed.data;
  ...
  const office = await prisma.office.create({ data: { name: practiceName, isProspect: true } });
