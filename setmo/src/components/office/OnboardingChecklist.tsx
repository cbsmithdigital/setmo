...
// First-run checklist (account activation or setter first-reps). Renders nothing
// once every step is complete.
export function OnboardingChecklist({
  data,
  title = "Get set up",
  subtitle = "A few quick steps to get your practice running. This disappears once you’re all set.",
}: {
  data: Data;
  title?: string;
  subtitle?: string;
