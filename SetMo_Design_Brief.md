...
**Companion to:** SetMo PRD v1.3 (product behavior lives there; this covers what to design and how it should look)
**Date:** June 7, 2026
...
- **Distributor / Consultant (partner):** Dashboard · Sign up a practice/DSO · Managed accounts (book of business) · (Distributor: Consultants, network rollups)
- **Platform Admin:** Practices · Partners (approve & set commission) · Agents · Training Catalog · Global Leaderboard
...
**Distributor / Consultant — partner portal** (Later)
- Partner dashboard — managed accounts and their status.
- Sign up a new practice/DSO — provision the account and invite its admin.
- Book of business — view and support managed accounts.
- Distributor only: manage Consultants and see network rollups.

**Platform Admin** (Later)
- Practices, agents, training catalog, global leaderboard.
- Partner approval & management — approve Distributors/Consultants and set the per-partner commission toggle/terms.
...
Secret shopper, consultative coach mode, the partner portal (Distributor/Consultant self-serve sign-up and management), deep Group/DSO and Platform Admin tooling, and content for service types beyond implants.
